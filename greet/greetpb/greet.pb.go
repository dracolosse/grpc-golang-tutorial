...
var file_greet_greetpb_greet_proto_rawDesc = []byte{
	...
	,
	...
	0x65, 0x22, 0x00, 0x12, 0x3b, 0x0a, 0x08, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x70, 0x6c, 0x79, 0x12,
	0x15, 0x2e, 0x67, 0x72, 0x65, 0x65, 0x74, 0x2e, 0x46, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x73, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x16, 0x2e, 0x67, 0x72, 0x65, 0x65, 0x74, 0x2e, 0x46,
	0x61, 0x63, 0x74, 0x6f, 0x72, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00,
...
var file_greet_greetpb_greet_proto_goTypes = []interface{}{
	...
	(*Factors)(nil),         // 3: greet.Factors
	(*FactorsRequest)(nil),  // 4: greet.FactorsRequest
	(*FactorsResponse)(nil), // 5: greet.FactorsResponse
}
var file_greet_greetpb_greet_proto_depIdxs = []int32{
	0, // 0: greet.GreetRequest.greeting:type_name -> greet.Greeting
	3, // 1: greet.FactorsRequest.factors:type_name -> greet.Factors
	1, // 2: greet.GreetService.Greet:input_type -> greet.GreetRequest
	4, // 3: greet.GreetService.Multiply:input_type -> greet.FactorsRequest
	2, // 4: greet.GreetService.Greet:output_type -> greet.GreetResponse
	5, // 5: greet.GreetService.Multiply:output_type -> greet.FactorsResponse
...
func (c *greetServiceClient) Multiply(ctx context.Context, in *FactorsRequest, opts ...grpc.CallOption) (*FactorsResponse, error) {
	out := new(FactorsResponse)
	err := c.cc.Invoke(ctx, "/greet.GreetService/Multiply", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedGreetServiceServer) Multiply(context.Context, *FactorsRequest) (*FactorsResponse, error) {
...
func _GreetService_Multiply_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FactorsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreetServiceServer).Multiply(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/greet.GreetService/Multiply",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetServiceServer).Multiply(ctx, req.(*FactorsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
